...
const mset:any = MAPSET;
const dset:any = DATASET;

const App = () => {

  const markers = Object.entries(dset["Country/Region Specific Geographic Coordinates"]);

  return (
    <div>
      <ComposableMap style={{ backgroundColor: "#5392fee6" }}>
        ...
        {
          markers.map(([country, coordinateData]:any /* marker */) => {
